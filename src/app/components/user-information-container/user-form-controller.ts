...
export class UserFormController {
  ...
  fulfillUserForm(user: ICountryUserInterface) {
    this.resetUserForm();
  ...
  private fulfillDependentsList(userDependentsList: ICountryDependentList) {
  ...
  private fulfillAddressList(userAddressList: ICountryAddressList) {
  ...
  private fulfillPhoneList(userPhoneList: ICountryPhoneList) {
